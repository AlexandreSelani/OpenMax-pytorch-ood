...
def main():
    ...
    dataset_train,dataset_val = validation_split(0.05,mnist,seed)
    ...
    targets_antigos = dataset_in_test.targets
    ...
    confusion_matrix(test_loader,targets_antigos,nome_classes_originais,[],detector)
