...
imagens = ImageFolder('/home/alexandreselani/Desktop/Segmentacao/ImagensCortadas/Alexandre/Dataset/Todas/KKC',transform=transforms)
...
results.loc[len(results)] = ["DESVIO PADRAO",acc.std(),f1.std(),precision.std(),recall.std()]

results.to_csv("Resultados_milho_solo.csv",index=False)
